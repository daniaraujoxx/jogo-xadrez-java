...
public class UI {
	...
	// codigo especial das cores para imprimir no console
	// cores do texto
	...
	public static ChessPosition readChessPosition(Scanner sc) { // esse metodo esta recebendo o scanner lá da program,
																// la está sendo instanciado e neste metodo está sendo
																// recebido como argumento e a leitura da posição vai
																// ser feita usando o scanner
		try {
	...
	public static void printMatch(ChessMatch chessMatch, List<ChessPiece> captured) {
		printBoard(chessMatch.getPieces()); // imprimindo tabuleiro
		System.out.println();
